...
export default function HurturOtel() {
  ...
  useEffect(() => {
    ...
    if (scrollContainer) {
      ...
      // Sayfa yüklendiğinde ve resize'da merkeze al
      centerScroll();
  ...
  // Scroll göstergelerini güncelle
  ...
  const getTypeIcon = (type) => {
    ...
    if (type === 'city') return <MapPin size={20} />;
    ...
    <div className="hurtur-container">
      ...
      <section id="location" className="section location-section">
        <div className="section-content">
          ...
          <div className="location-wrapper">
            ...
            <div className="hotel-label">Hürtur Otel</div>
      ...
      <style>{`
        ...
        * {
        ...
        .map-visual-new::-webkit-scrollbar {
          display: none;
        }
